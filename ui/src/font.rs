/// Standard 8x8 monochrome bitmap font (ASCII 32 - 127)
/// Each character consists of 8 rows, 1 byte per row.
/// Bit 7 (MSB) = leftmost pixel, Bit 0 (LSB) = rightmost pixel.
pub static FONT8X8_BASIC: [[u8; 8]; 96] = [
    ...
    [0x7E, 0x7E, 0x7E, 0x7E, 0x7E, 0x7E, 0x7E, 0x00], // 127 DEL / box
];

pub fn get_glyph(ch: char) -> &'static [u8; 8] {
    let code = ch as usize;
    if (32..128).contains(&code) {
        &FONT8X8_BASIC[code - 32]
    } else {
        &FONT8X8_BASIC['?' as usize - 32]
    }
}
